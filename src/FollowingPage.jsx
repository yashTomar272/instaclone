   ...
   const handleFollow = async (event, userToFollow) => {
    ...
    return (
        <>
            ...
            <div className={`${following ? "" : "d-none"} w-100 DALJU position-fixed top-0 w-100 h-100 `} onClick={() => setFollowing(false)} style={{ height: "100vh", background: "rgba(0,0,0,0.65)", zIndex: "1001" }}>
 ...
 {filterData.length > 0 ? (
  ...
  {loading ? (
          ...
          <Layout >
            ...
            <div className={`${following ? "" : "d-none"} w-100 DALJU position-fixed top-0 w-100 h-100 `} onClick={() => setFollowing(false)} style={{ height: "100vh" }}>
...
<div style={{ transform: "rotate(270deg)"}}  onClick={() => setFollowing(false)} className="cr"><Left/></div>
